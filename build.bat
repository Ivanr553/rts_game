...
set game_units=src\game\game_entities\units\worker.c src\game\game_entities\units\resource.c
...
set ui_entities=src\game\game_entities\ui\command_board\command_board.c src\game\game_entities\ui\building_selection\building_selection.c src\game\game_entities\ui\command_board\command_board_buttons.c src\game\game_entities\ui\player_ui\player_resources.c src\game\game_entities\ui\command_board\command_board_selection_icon.c
set entity_components=src\game\game_entities\components\harvester.c src\game\game_entities\components\selector.c src\game\game_entities\components\building_component.c src\game\game_entities\components\resource_component.c src\game\game_entities\components\ui_component.c src\game\game_entities\components\selectable_component.c
...
:: Organizing files
set game_files=%game_constants% %game% %game_entities% %state% %state_events% %game_map% %game_core% %stores% %ui_entities% %game_buildings% %entity_components% %game_units%
